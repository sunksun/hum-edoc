        ...
        <div class="main-panel">
          <div class="content-wrapper">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"><?php echo $row["name"];?> <?php echo $row["dep"];?></h4>
                    <table class="table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="user-page-edit.php?memo_id=<?php echo $result["memo_id"];?>"><?php echo mb_substr($result["title"],0,50,'UTF-8');?></a></td>
