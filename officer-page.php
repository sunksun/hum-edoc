      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="all-member-menament.php">
                <i class="menu-icon typcn typcn-shopping-bag"></i>
                <span class="menu-title">จัดการข้อมูลผู้ใช้งาน</span>
              </a>
            </li>
            <li class="nav-item">
        ...
        <div class="main-panel">
          ...
          <div class="content-wrapper">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"><?php echo $row["name"];?> ธุรการ<?php echo $row["dep"];?></h4>
                    <table class="table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="officer-page-check.php?memo_id=<?php echo $result["memo_id"];?>&user_id=<?php echo $result["user_id"];?>"><?php echo mb_substr($result["title"],0,40,'UTF-8');?></a></td>
                          <td><?php echo $result["time_user"];?></td>
