        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <a class="nav-link" href="head-officer-page.php">
              ...
              <div class="col-12 grid-margin">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="comment-form" id="commentform" method="post" action="head-officer-page-update.php" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">เลขรับบันทึกข้อความคณะ</label>
                            <div class="col-sm-9">
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" value="<?php echo $result["comment3"];?>" name="" readonly />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea class="form-control" id="exampleTextarea1" rows="1" name="" readonly><?php echo $result["officer1_opinion"];?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">เสนอความคิดเห็นหัวหน้าสำนักงาน</label>
                            <div class="col-sm-9">
                              <textarea class="form-control" id="exampleTextarea4" rows="3" name="head_officer_opinion" ></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">ลงชื่อหัวหน้าสำนักงาน</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" value="" name="sign_head_officer" required />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea class="form-control" id="exampleTextarea1" rows="1" name="comment4"></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
