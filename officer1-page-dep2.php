...
<html lang="en">
  ...
  <head>
    ...
    <title>ภาควิชาสังคมศาสตร์</title>
  ...
  <body>
    ...
    <div class="container-scroller">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <?php
          $sql="SELECT * FROM memo WHERE dep = 'ภาควิชาสังคมศาสตร์' ORDER BY id DESC";
                    ...
                    <table class="table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $result["memo_num_dep"];?></td>                     <td><?php echo $result["memo_date"];?></td>
                          ...
                          <td><?php echo substr($result["dep"],21);?></td>
                          <td align="center">
                            <?php
