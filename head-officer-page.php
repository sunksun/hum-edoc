...
<html lang="en">
  ...
  <head>
    ...
    <title>เจ้าหน้าที่ : <?php echo $name; ?></title>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"><?php echo $row["name"];?> <?php echo $row["field"];?></h4>
                    <table class="table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="head-officer-page-check.php?memo_id=<?php echo $result["memo_id"];?>&user_id=<?php echo $result["user_id"];?>"><?php echo mb_substr($result["title"],0,30,'UTF-8');?></a></td>
