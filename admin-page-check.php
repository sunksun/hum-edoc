...
<html lang="en">
  ...
  <head>
    ...
    <title>คณบดี : <?php echo $name; ?></title>
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="comment-form" id="commentform" method="post" action="admin-page-update.php" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group">
                            ...
                            {
                            ?>
                              <span><a href="files/upload/<?php echo $result["name"];?>/<?php echo $result["memo_date"];?>/<?php echo $result_file["file_name"]; ?>"><?php echo $result_file["file_name"]; ?></a></span>
                            <?php
                            }
                            ?>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea class="form-control" id="exampleTextarea1" rows="2" name="admin_opinion" ></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">ลงชื่อคณบดี</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" value="" name="sign_admin" required />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea class="form-control" id="exampleTextarea1" rows="1" name="comment5"></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
