                    ...
                    <table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="user-officer-page-edit.php?memo_id=<?php echo $result["memo_id"];?>"><?php echo mb_substr($result["title"],0,40,'UTF-8');?></a></td>
                          ...
                          <td align="center">
                              <a href="Template.php?memo_id=<?php echo $result["memo_id"];?>"><img src="assets/images/download-button.png" alt=""/></a>
                          </td>
                        </tr>
                        <?php
                            $i++;
