...
<html lang="en">
  <head>
    ...
    <title>เจ้าหน้าที่ : <?php echo $_SESSION['name']; ?></title>
    <!-- plugins:css -->
            ...
            <li class="nav-item dropdown d-none d-xl-inline-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-item-content flex-grow py-0">
                    <p class="preview-subject ellipsis font-weight-medium text-dark"><?php echo $i;?>. <?php echo $result["title"];?> </p>
                    <p class="font-weight-light small-text">สถานะ : 
                    <?php
                    $status = $result["status"];;

                    if ($status == "1") {
                      echo "<img src='assets/images/timeline1.png' alt='' width='80%'/>";
                    } elseif ($status == "2") {
                      echo "<img src='assets/images/timeline2.png' alt='' width='80%'/>";
                    } elseif ($status == "3") {
                      echo "เสนอคณบดี";
                    } else {
                      echo "<img src='assets/images/timeline.png' alt='' width='80%'/>";
                    }
                    ?>
                    </p>
                  </div>
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea class="form-control" id="exampleTextarea1" rows="10" placeholder="" name="paragraph1"><?php echo $result["paragraph1"];?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea class="form-control" id="exampleTextarea1" rows="5" name="paragraph2"><?php echo $result["paragraph2"];?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea class="form-control" id="exampleTextarea1" rows="1" placeholder="" name="paragraph3"><?php echo $result["paragraph3"];?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group">
                            ...
                            {
                            ?>
                              <span><a href="files/upload/<?php echo $result["name"];?>/<?php echo $result_file["file_name"]; ?>"><?php echo $result_file["file_name"]; ?><img src="assets/images/delete.png" alt=""/></a></span>
                            <?php
                            }
                            ?>
                          </div>
