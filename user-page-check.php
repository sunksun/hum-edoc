...
<html lang="en">
  <head>
    ...
    <title>อาจารย์ : ตรวจสอบบันทึกข้อความ</title>
    <!-- plugins:css -->
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list pb-0" aria-labelledby="messageDropdown">
                ...
                <a class="dropdown-item preview-item">
                  <div class="preview-item-content flex-grow py-2">
                    ...
                    if ($status == "1") {
                      echo "เสนอหัวหน้าภาควิชา";
                    } elseif ($status == "2") {
                      echo "ธุรการสำนักงานคณบดี";
                    } elseif ($status == "3") {
                      echo "เสนอคณบดี";
                    } else {
...
" alt="profile image">
        ...
        <!-- partial -->
        <?php
          $sql="SELECT * FROM memo WHERE name = '$name' AND dep='$dep' ORDER BY id DESC";
          $query = mysqli_query($conn,$sql);
          $rowcount=mysqli_num_rows($query);
        ?>
        <div class="main-panel">
          <div class="content-wrapper">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"><?php echo $row["dep"];?></h4>
                    <table>
                      <thead>
                        <tr>
                          <th> ลำดับที่ </th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="officer-page-check.php"><?php echo mb_substr($result["title"],0,50,'UTF-8');?></a></td>
