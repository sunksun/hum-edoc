<?php   
    ...
    if ($dep == "ภาควิชามนุษยศาสตร์"){
        $num_dep = "ภม.";
    } else {
        $num_dep = "ภส.";
    }

    $sqlnum_dep="SELECT * FROM memo WHERE memo_num_dep LIKE '$num_dep%' ";
    $querysqlnum_dep = mysqli_query($conn,$sqlnum_dep);
	$rowcount=mysqli_num_rows($querysqlnum_dep);
    $memo_num_dep = $rowcount + 1;
	$memo_num_dep = "000000".$memo_num_dep."/64" ;
	$memo_num_dep = substr($memo_num_dep, -6);
...
<html lang="en">
  <head>
    ...
    <title><?php echo $name; ?> : <?php echo $dep; ?></title>
    <!-- plugins:css -->
              ...
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="comment-form" id="commentform" method="post" action="officer-page-update.php" enctype="multipart/form-data">
                      <input type="hidden" name="memo_id" value="<?php echo $result["memo_id"];?>">
                      <input type="hidden" name="dep" value="<?php echo $result["dep"];?>">
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">เลขที่ภาควิชา <?php echo $result["memo_num_dep"];?></label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" value="<?php
                                $t = $result["memo_num_dep"];
                                    if ($t != '') {
                                      echo $result["memo_num_dep"];
                                    } else {
                                      echo $num_dep.''.$memo_num_dep;
                                    }
                                ?>" name="memo_num_dep" readonly/>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">ข้อสั่งการคณบดี</label>
                            <div class="col-sm-9">
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">ลงชื่อเจ้าหน้าที่</label>
                            <div class="col-sm-9">
                              <input type="text" class="form-control" value="<?php echo $result["sign_officer"];?>" name="sign_officer" required />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-8">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <textarea class="form-control" id="exampleTextarea1" rows="1" name="comment1"><?php echo $result["comment1"];?></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
